    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="card-box">
                ...
                <h2 class="text-primary my-4 text-center">$<span data-plugin="counterup">31,570</span>
                </h2>
                <div class="row mb-4">
                    <div class="col-6">
                    ...
                    <div id="cardCollpase1" class="collapse pt-3 show">
                        ...
                        <div class="dash-item-overlay d-none d-md-block">
                            ...
                            <p class="text-muted font-13 mb-3 mt-2">Etiam ultricies nisi vel augue.
                                Curabitur ullamcorper ultricies nisi. Nam eget...</p>
                            <a href="javascript: void(0);" class="btn btn-primary">View Statements
                                <i class="mdi mdi-arrow-right ml-2"></i>
                            </a>
                        </div>
                        <div id="apex-line-1" class="apex-charts" style="min-height: 480px !important;">
                        </div>
                    </div> <!-- collapsed end -->
                </div> <!-- end card-body -->
            </div> <!-- end card-->
                    ...
                    <div class="media align-items-center">
                        <div class="media-body">
                            ...
                            <h3 class="m-0 font-weight-normal text-white sp-line-1 cta-box-title">
                                Special launcing <b>Discount</b> offer</h3>
                            <p class="text-white-50 mt-2 sp-line-2">Suspendisse vel quam malesuada,
                                aliquet sem sit amet, fringilla elit. Morbi tempor tincidunt tempor.
                                Etiam id turpis viverra.</p>
                            <a href="javascript: void(0);"
                                class="text-white font-weight-semibold text-uppercase">Read More <i
                                    class="mdi mdi-arrow-right"></i></a>
                        </div>
                        <img class="ml-3" src="assets\images\update.svg" width="120"
                    ...
                    <div id="cardCollpase4" class="collapse pt-3 show">
                        <div class="row">
                            ...
                            <div class="col-md-4 align-self-center">
                                ...
                                <h5 class="mb-1 mt-0">51,480 <small
                                        class="text-muted ml-2">www.youtube.com</small></h5>
                                <div class="progress-w-percent">
                                ...
                                <h5 class="mb-1 mt-0">45,760 <small
                                        class="text-muted ml-2">www.dribbble.com</small></h5>
                                <div class="progress-w-percent">
                                ...
                                <h5 class="mb-1 mt-0">98,512 <small
                                        class="text-muted ml-2">www.behance.net</small></h5>
                                <div class="progress-w-percent">
                                ...
                                <h5 class="mb-1 mt-0">2,154 <small
                                        class="text-muted ml-2">www.vimeo.com</small></h5>
                            ...
                            <div class="timeline-alt">
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="#"
                                            class="text-body font-weight-semibold mb-1 d-block">You sold
                                            an item</a>
                                        <small>Paul Burgess just purchased “Upvex - Admin
                                            Dashboard”!</small>
                                        <p>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="#"
                                            class="text-body font-weight-semibold mb-1 d-block">Product
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="#"
                                            class="text-body font-weight-semibold mb-1 d-block">Robert
                                            Delaney</a>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="#"
                                            class="text-body font-weight-semibold mb-1 d-block">Audrey
                                            Tobey</a>
                                        <small>Uploaded a photo
                                            <span class="font-weight-semibold">"Error.jpg"</span> Please
