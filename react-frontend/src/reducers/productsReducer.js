...
const initialState = {
  ...
  products: [
    ...
    },
    {
      ...
      product_detail:
        "Balance Belgian Milk Chocolate Bar is a healthier way to indulge your sweet tooth. Made with maltitol and free from sugar, Balance brings you the best bits of milk chocolate without the added sugar.",
    ...
    },
    {
      ...
      product_detail:
        "The candy is covered with chocolate, fatty, greasy but not too sweet. Convenient and delicious when eaten cold",
    ...
    },
    {
      ...
      product_detail:
        "We have carefully selected the best ingredients to create our Stevia dark chocolate bar. So what you experience is a luxurious, velvety chocolate that has the rich deep taste that comes with dark chocolate.",
    ...
    },
    {
      ...
      product_detail:
        "Finest Cocoa, Unique Roasting & Grinding, The Lindt Invention, Best Ingredients, Finishing With Perfection",
      product_thumbnail_name:
        "F122061_Lindt_Lindor_Assorted_168g_00b9_b9d5.jpg",
    },
    {
      product_SKU: "7",
      category_name: "Food",
