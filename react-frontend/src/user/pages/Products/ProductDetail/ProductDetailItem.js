              ...
              <div className="row">
                  <div className="col-sm-3" style={{margin:'0px',paddingRight:'0px'}}>
                      <div className="nav flex-column nav-pills nav-pills-tab" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                          <Link className="nav-link active show" id="v-pills-home-tab" data-toggle="pill" to="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">
                              DETAILS</Link>
                          <Link className="nav-link" id="v-pills-profile-tab" data-toggle="pill" to="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                              INGREDIENTS</Link>
                          <Link className="nav-link" id="v-pills-messages-tab" data-toggle="pill" to="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                              INSTRUCTIONS FOR USE</Link>
                          <Link className="nav-link" id="v-pills-settings-tab" data-toggle="pill" to="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                              STORAGE INSTRUCTIONS</Link>
                          <Link className="nav-link mt-3" id="v-pills-settings-tab" data-toggle="pill" to="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false" style={{borderBottom:'none'}}>
                              REVIEWS</Link>
                      </div>
                  </div> 
                  ...
                  <div className="col-sm-9">
                      <div className="tab-content pt-0">
                          <div className="tab-pane fade active content" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
